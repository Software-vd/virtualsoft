...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { Codigo: @producto.Codigo, tamano_id: @producto.tamano_id, tipo_id: @producto.tipo_id, valor_id: @producto.valor_id }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { Codigo: @producto.Codigo, tamano_id: @producto.tamano_id, tipo_id: @producto.tipo_id, valor_id: @producto.valor_id }
    assert_redirected_to producto_path(assigns(:producto))
  end
